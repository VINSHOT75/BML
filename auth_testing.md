...
curl -X GET "https://your-app.com/api/vehicles" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X POST "https://your-app.com/api/vehicles" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"registration_number": "MH12AB1234", "vehicle_type": "Truck", "make": "Tata", "model": "Prima", "year": 2022, "capacity_tons": 25, "fuel_type": "Diesel"}'
```
